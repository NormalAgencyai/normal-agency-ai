// ==========================================
// وكالة نورمال - البرمجة التفاعلية (دعم 3 لغات)
// ==========================================
...
const servicesData = {
    'Digital': {
        ...
        items: [
            ...
            { ar: 'إطلاق الحملات الإعلانية', en: 'Ad Campaigns Launch', fr: 'Lancement de campagnes publicitaires', price: '250' },
            { ar: 'كتابة المحتوى والسيناريو', en: 'Content & Scriptwriting', fr: 'Rédaction de contenu et scénario', price: '75' },
            { ar: 'إنشاء المواقع والمتاجر', en: 'Web & E-Commerce Dev', fr: 'Création de sites et boutiques', price: '490' },
            { ar: 'تحسين محركات البحث SEO', en: 'SEO Optimization', fr: 'Optimisation SEO', price: '350' },
            { ar: 'استراتيجية التسويق الرقمي', en: 'Digital Marketing Strategy', fr: 'Stratégie de marketing numérique', price: '400' },
            { ar: 'تحليل البيانات والتقارير', en: 'Data Analytics & Reports', price: '200' },
            { ar: 'التسويق عبر البريد', en: 'Email Marketing', fr: 'Marketing par e-mail', price: '150' },
            { ar: 'إدارة حملات المشاهير', en: 'Influencer Campaigns', fr: 'Gestion de campagnes d’influenceurs', price: '500' },
            ...
            { ar: 'إدارة سمعة العلامة التجارية', en: 'Brand Reputation Mgmt', fr: 'Gestion de la réputation', price: '300' },
            { ar: 'ربط البوابات والأدوات', en: 'API & Tool Integration', fr: 'Intégration d’API et d’outils', price: '250' },
            { ar: 'إدارة الحملات التفاعلية', en: 'Interactive Campaigns', fr: 'Campagnes interactives', price: '300' },
            { ar: 'إعداد خطط نشر المحتوى', en: 'Content Calendar Planning', fr: 'Planification du calendrier', price: '120' }
        ]
    },
    'Studio': {
        ...
        items: [
            ...
            { ar: 'تصحيح وتدرج الألوان', en: 'Color Grading', fr: 'Étalonnage des couleurs', price: '90' },
            { ar: 'إنتاج فيديو إعلاني كامل', en: 'Commercial Video Production', fr: 'Production vidéo commerciale', price: '390' },
            { ar: 'المؤثرات البصرية Visual Effects', en: 'VFX & Visual Effects', fr: 'Effets visuels (VFX)', price: '180' },
            { ar: 'تصوير منتجات ميداني', en: 'Product Photography', fr: 'Photographie de produits', price: '350' },
            { ar: 'المونتاج السينمائي', en: 'Cinematic Editing', fr: 'Montage cinématographique', price: '250' },
            { ar: 'المؤثرات الصوتية والهندسة', en: 'Sound Design & Engineering', fr: 'Design sonore et ingénierie', price: '100' },
            { ar: 'تصوير وتسجيل ستوديو', en: 'Studio Shooting & Recording', fr: 'Tournage en studio', price: '400' },
            { ar: 'إنتاج فيديو موشن جرافيك', en: 'Motion Graphics Video', fr: 'Production Motion Design', price: '220' },
            { ar: 'مونتاج الريلز والشورتس', en: 'Reels & Shorts Editing', fr: 'Montage Reels & Shorts', price: '60' },
            { ar: 'تأجير معدات إضاءة واستوديو', en: 'Studio Equipment Rental', fr: 'Location d’équipement', price: '300' },
            { ar: 'إخراج كليبات وإعلانات', en: 'Directing Services', fr: 'Réalisation d’annonces', price: '600' },
            { ar: 'تغطية الفعاليات والمؤتمرات', en: 'Event Coverage', fr: 'Couverture d’événements', price: '500' },
            { ar: 'البث المباشر الاحترافي', en: 'Professional Live Streaming', fr: 'Diffusion en direct', price: '450' },
    ...
    'Art': {
        ...
        items: [
            ...
            { ar: 'تصاميم السوشيال ميديا', en: 'Social Media Designs', fr: 'Design pour réseaux sociaux', price: '35' },
            { ar: 'تصميم البكجات والتغليف', en: 'Packaging Design', price: '220' },
            { ar: 'تصميم الملف التعريفي Profile', en: 'Company Profile Design', fr: 'Design de profil d’entreprise', price: '190' },
            ...
            { ar: 'تصميم واجهات المستخدم UI/UX', en: 'UI/UX Interface Design', fr: 'Design d’interface UI/UX', price: '400' },
            { ar: 'تصميم القوائم والمنيو', en: 'Menu Design', fr: 'Design de menu', price: '110' },
            { ar: 'تصميم كروت الأعمال', en: 'Business Cards Design', fr: 'Design de cartes de visite', price: '50' },
    ...
    'Print': {
        ...
        items: [
            { ar: 'طباعة كروت وأوراق رسمية', en: 'Business Cards Printing', fr: 'Impression de cartes de visite', price: '75' },
            { ar: 'طباعة التغليف والأكياس', en: 'Packaging Printing', fr: 'Impression d’emballages', price: '190' },
            { ar: 'طباعة الهدايا الدعائية', en: 'Promo Gifts Printing', fr: 'Impression de cadeaux', price: '120' },
            ...
            { ar: 'طباعة المنسوجات والزي', en: 'Apparel & Uniform Printing', fr: 'Impression sur textiles', price: '140' },
            ...
            { ar: 'طباعة الأوراق الذهبية', en: 'Gold Foil Printing', fr: 'Impression dorure à chaud', price: '180' },
...
function toggleLanguage() {
    // التبديل بين اللغات: عربية -> إنجليزية -> فرنسية -> عربية
    if (currentLang === 'ar') currentLang = 'en';
    else if (currentLang === 'en') currentLang = 'fr';
    else currentLang = 'ar';

    // 1. تحديث كافة النصوص الواجهة بناء على data-attributes
    ...
    // 2. تحديث الـ Placeholders في المدخلات
    ...
    // 3. تحديث اسم اللغة في الزر نفسه
    const langBtnText = document.getElementById('langText');
    if (langBtnText) {
        langBtnText.innerText = currentLang === 'ar' ? 'العربية' : (currentLang === 'en' ? 'English' : 'Français');
    }

    // 4. تغيير اتجاه الصفحة (RTL / LTR)
    document.documentElement.dir = currentLang === 'ar' ? 'rtl' : 'ltr';

    // 5. إذا كانت النافذة المنبثقة مفتوحة، أعد تحديث خدماتها للغة الجديدة
    const modal = document.getElementById('modal');
    if (modal && modal.style.display === 'block' && currentCategory) {
